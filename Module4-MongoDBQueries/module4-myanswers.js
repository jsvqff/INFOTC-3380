...
db.zips.find({"state": "IL"}, {"_id": 1, "city": 1})
...
db.zips.find({$and:[{"state": "OH", "pop": {$lt: 2000}}]}, {"_id": 1, "city": 1, "pop": 1})
...
db.stocks.find({"Sector": "Real Estate", "Price": { $lt: 50 } }, {"_id": 0, "Name": 1, "Symbol": 1, "Price": 1})  
